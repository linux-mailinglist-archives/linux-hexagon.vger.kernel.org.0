Return-Path: <linux-hexagon+bounces-455-lists+linux-hexagon=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-hexagon@lfdr.de
Delivered-To: lists+linux-hexagon@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 41DBF9A09A2
	for <lists+linux-hexagon@lfdr.de>; Wed, 16 Oct 2024 14:27:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id EF10F28206B
	for <lists+linux-hexagon@lfdr.de>; Wed, 16 Oct 2024 12:27:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 74256209678;
	Wed, 16 Oct 2024 12:26:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="MuK+uMsS"
X-Original-To: linux-hexagon@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2F45F20823D;
	Wed, 16 Oct 2024 12:26:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1729081592; cv=none; b=EdoVm04owaPWBOeS0iLrQq88dTgF7D4R1epSuTJyngUJCKT9uv3GXREzXeQVmugQREcDi7wM0xQtrL0vQtEbtgCXtxk/7ynVnL+W12R8Q1CdbKuQhx0xx/gY2G1E1Rs02caIBCiqKPfVtGsGOS1O7G05DV7ZXN5L3mYgI714jJI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1729081592; c=relaxed/simple;
	bh=Az0XHXAW6vRgwH3QEjEYsybAq9IPVKTfa81a9VqCSsQ=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=MVPdWv9o1obfM8nyeLNeG3bM7ghLDcs9f6M+oUTSNlpqsRI6OVGki3GKGiyMxItaygfCeZCt6w6cIxrHCG2DbPy1NPL4cTIV7P18antg+2knudtVkz+gmQxIvs6HJ1TH+BsBkeAGAOjvUgrA1LmtlccgN0FNOl2Gmp7wsjhHrgk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=MuK+uMsS; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 12355C4CEC7;
	Wed, 16 Oct 2024 12:26:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1729081591;
	bh=Az0XHXAW6vRgwH3QEjEYsybAq9IPVKTfa81a9VqCSsQ=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
...
Cc: Andreas Larsson <andreas@gaisler.com>,
	...
	x86@kernel.org
Subject: [PATCH v6 6/8] x86/module: prepare module loading for ROX allocations of text
Date: Wed, 16 Oct 2024 15:24:22 +0300
Message-ID: <20241016122424.1655560-7-rppt@kernel.org>
...
index d17518ca19b8..cf782f431110 100644
...
@@ -1154,26 +1174,29 @@ static int cfi_enable_callers(s32 *start, s32 *end)
...
@@ -1182,18 +1205,19 @@ static int cfi_rand_preamble(s32 *start, s32 *end)
 			return -EINVAL;
...
+		void *wr_addr = module_writable_address(mod, addr);
 		...
 		hash = decode_preamble_hash(addr);
@@ -1201,59 +1225,64 @@ static int cfi_rewrite_preamble(s32 *start, s32 *end)
 			 addr, addr, 5, addr))
 			return -EINVAL;
